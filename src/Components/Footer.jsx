        ...
        <footer className="relative bg-blueGray-200 pt-8 pb-6 bg-white shadow-md border-t border-gray-300">
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap text-center lg:text-left">
                    <div className="w-full lg:w-4/12 px-4 mb-5">
                        ...
                        <div className="flex flex-wrap items-top mb-6">
                            <div className="w-6/12 md:w-4/12 px-4 ml-auto">
                                <ul className="list-unstyled">
                                    ...
                                    <li>
                                        <Link className="text-blueGray-600 hover:text-red-900 font-semibold block pb-2 text-sm" to="/my-profile">Pricing & Subscription</Link>
                                    </li>
                                    {/* <li>
                                        <Link className="text-blueGray-600 hover:text-red-900 font-semibold block pb-2 text-sm" to="/my-profile/pricing">Pricing</Link>
                                    </li> */}
                                    <li>
                                        <a className="text-blueGray-600 hover:text-red-900 font-semibold block pb-2 text-sm" href="/saas">OpenAI GPT-4 SaaS For Business</a>
                                    </li>
                                    {/* <li>
                                        <form className="inline-block" method="POST" action={props.store.baseURL + "user/stripe/customer-portal"}>
                                            <input type="hidden" name="token" value={props.store.api.defaults.headers.common['x-access-token']} />
                                            <button className="text-blueGray-600 hover:text-red-900 font-semibold block pb-2 text-sm">Pricing & Subscription</button>
                                        </form>
                                    </li> */}
                                    <li>
                            ...
                            <div className="w-full lg:w-4/12 px-4 flex justify-center mt-6 md:mt-0">
                                <div className="payment-logo flex flex-col gap-3 justify-center">
                                    <div className="flex gap-4 items-center md:flex-col">
                                        <img width="100px" src="/klarna_logo.png" alt="" />
                                        <img width="100px" src="/stripe_logo.png" alt="" />
                                    </div>
                ...
                <div className="flex flex-wrap items-center md:justify-between justify-center">
                    <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                        <div className="text-sm text-blueGray-500 font-semibold py-1">
                            ...
                            <Link to="/" className="text-blueGray-500 hover:text-red-900"> Jowry</Link>.
                        </div>
                    </div>
                </div>
            </div>
